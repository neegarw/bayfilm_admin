                ...
                <div className="h-screen flex flex-col justify-center items-center">
                    {admin ?
                        <>
                            ...
                            <p className="mt-6 text-4xl font-medium text-gray-800">Yüklənir...</p>
                        </>
                        :
                        <>
                            <h1 className="text-8xl font-bold text-gray-800">404</h1>
                            <p className="text-4xl font-medium text-gray-800">Page Not Found</p>
                            <Link to="/" className="mt-4 text-xl text-blue-600 hover:underline">Ana sehifeye geri qayit</Link>
                        </>
                    }
                </div>
            </div>
